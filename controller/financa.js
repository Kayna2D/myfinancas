...
module.exports = {
    ...
    async update(request, response){
        try {
           ...
           const {
            ...
            return response.json({ msg: "Não foi possível alterar " + error });
        }
    },
    ...
    async delete(request, response){
        try{
            ...
            return response.json({ msg: "Excluído com sucesso" });
        }catch(error){
    ...
    async findById(request, response){
        try {           
            ...
            return response.json("Erro ao listar finanças por categoria " + error);
        }
